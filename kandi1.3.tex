...
Tutkielmassa perehdytään siihen, mitä uusia mahdollisuuksia älykellojen liikesensoridata tarjoaa QWERTY-näppäimistön käytön päättelyyn, sekä millä menetelmillä liikesensoridatasta on mahdollista päätellä käyttäjän näppäimistön käyttöä. 
...
TUTKIMUSKYSYMYKSET; TULOKSET; IMPAKTI
...
\begin{table} [h]
    \begin{tabular}{ | p{10mm} | p{25mm} | p{2mm} | p{2mm} | p{20mm} | p{10mm} | c | }
